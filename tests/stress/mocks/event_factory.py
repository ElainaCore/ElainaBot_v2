...
class EventFactory:
    ...
    @classmethod
    def group_at_message(cls, content, user_id='user_001', group_id='group_001', appid='102000001', is_at_self=True, is_at_all=False, is_bot=False):
    ...
    @classmethod
    def group_message(cls, content, user_id='user_001', group_id='group_001', appid='102000001', is_at_self=False, is_at_all=False, is_bot=False):
    ...
    @classmethod
    def group_at_all(cls, content, user_id='user_001', group_id='group_001', appid='102000001'):
    ...
    @classmethod
    def channel_message(cls, content, user_id='user_001', channel_id='chan_001', guild_id='guild_001', appid='102000001'):
    ...
    @classmethod
    def channel_direct_message(cls, content, user_id='user_001', guild_id='guild_001', appid='102000001'):
    ...
    @classmethod
    def interaction(cls, interaction_id='inter_001', appid='102000001', user_id='user_001', data=None):
    ...
    @classmethod
    def lifecycle(cls, event_type, appid='102000001', user_id='user_001', group_id='group_001'):
    ...
    @classmethod
    def group_member(cls, event_type, appid='102000001', user_id='user_001', group_id='group_001'):
    ...
    @classmethod
    def batch_group_messages(cls, count, content_pattern='/ping {i}', group_ids=None, user_ids=None, appid='102000001'):
    ...
    def batch_mixed_events(cls, count, appid='102000001'):
        ...
        for i in range(count):
            r = i % 20
            if r < 8:  # 40% GROUP_AT
                events.append(cls.group_at_message(f'/ping_{i}', f'user_{i:04d}', 'group_001', appid))
            elif r < 12:  # 20% GROUP (non-@)
                events.append(cls.group_message(f'hello_{i}', f'user_{i:04d}', 'group_001', appid, is_at_self=False))
            elif r < 15:  # 15% C2C
                events.append(cls.direct_message(f'/help_{i}', f'user_{i:04d}', appid))
            elif r < 17:  # 10% INTERACTION
                events.append(cls.interaction(f'inter_{i}', appid, f'user_{i:04d}'))
            elif r < 18:  # 5% REACTION (silent)
                events.append(cls.reaction_add(f'user_{i:04d}', 'group_001', appid))
            elif r < 19:  # 5% FRIEND_ADD (lifecycle)
                events.append(cls.lifecycle(FRIEND_ADD, appid, f'user_{i:04d}'))
