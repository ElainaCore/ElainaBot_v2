...
class TestMessageChats:
    ...
    async def test_get_chats(self, api_client, auth_cookies):
    ...
    async def test_get_chats_with_search(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/chats',
    ...
    async def test_get_chats_pagination(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/chats',
...
class TestMessageHistory:
    ...
    async def test_get_history_missing_chat_id(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/history',
            json={},
            cookies=auth_cookies,
    ...
    async def test_get_history_with_chat_id(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/history',
    ...
    async def test_get_history_with_before_date(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/history',
            json={
                'chat_type': 'group',
...
class TestMessageSend:
    ...
    async def test_send_missing_params(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/send',
            json={},
            cookies=auth_cookies,
    ...
    async def test_send_empty_content(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/send',
...
class TestMessageNickname:
    ...
    async def test_get_nickname_missing_uid(self, api_client, auth_cookies):
        resp = await api_client.post(
    ...
    async def test_get_nickname(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/nickname',
    ...
    async def test_get_nicknames_batch_missing_uids(self, api_client, auth_cookies):
        resp = await api_client.post(
    ...
    async def test_get_nicknames_batch(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/nicknames',
...
class TestMessageRecall:
    ...
    async def test_recall_missing_params(self, api_client, auth_cookies):
        resp = await api_client.post(
            '/api/message/recall',
            json={},
            cookies=auth_cookies,
